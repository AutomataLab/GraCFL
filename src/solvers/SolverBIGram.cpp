...
// namespace gracfl 
// {
//     SolverBIGram::SolverBIGram(Grammar* grammar, std::unique_ptr<Graph> graph)
//     {
//         grammar_ = grammar;
...
//             itr++;
//             terminate = true;
//             runSingleIteration(grammar, terminate);
//             std::cout << "Iteration " << itr << std::endl;
//         } while(!terminate);
//     }

//     void  SolverBIGram::runSingleIteration(bool& terminate)
//     {
